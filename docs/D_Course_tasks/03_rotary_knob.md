...
- The `Rotary_Pot` block maps the analog input to a beam angle in **radians**.
...
| Step             | Action                                                             |
|------------------|--------------------------------------------------------------------|
| Hardware         | Rotary knob connected to `Rotary` Grove input                      |
| Simulink Blocks  | `Rotary_Pot` block connected to `Servo_Position_Controller`     |
