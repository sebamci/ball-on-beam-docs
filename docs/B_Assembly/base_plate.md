...
1. **Mount the rubber feet**
    ...
    ![Rubber Foot (3D model)](images/Rubber_Foot.png)

    <center>Rubber Foot (3D model)</center>
...
3. **Install the SoftPot sensor**
    ...
    ![SoftPot Sensor](images/Softpot.jpg)

    <center>SoftPot Sensor</center>
...
4. **Srew down the Arduino Due and Shield**
    ...
    ![Arduino Shield (3D model)](images/Shield_Arduino.png)

    <center>Arduino Shield (3D model)</center>
...
<center>Base Plate with mounted components (3D model)</center>