...
1. **Attach the SoftPot Sensor**
    ...
    ![SoftPot mounted on beam (3D model)](images/Beam_SoftPot_Frame.png)
    <center>SoftPot mounted on beam (3D model)</center>
...
2. **Connect the Servo Linkage**
    ...
    ![Servo linkage connection (3D model)](images/Beam_Servo_Linkage.png)
    <center>Servo linkage connection (3D model)</center>
...
4. **Add Spacers and Countersunk Screws**
    ...
    <center>Beam structure with bearing mount (3D model)</center>
...
![Fully assembled beam (3D model)](images/Fully_Assembled_Beam.png)
<center>Fully assembled beam (3D model)</center>
